  ...
  """
    ...
    for epoch in tqdm(range(epochs)):
        ...
        for k, v in test_res.items():
            writer.add_scalar(f'{k}/eval', v, epoch)
...
def test(model: torch.nn.Module, dataloader: DataLoader, loss_fn: torch.nn.Module, device: torch.device,
         metrics: dict):
    res = test_step(model=model,
